...
import 'package:lo2ta/features/auth_module/presentation/widgets/glass_container.dart';
                        ...
                        children: [
                          ...
                          BlocConsumer<AuthCubit, AuthState>(
                            listener: (context, state) {
                              if (state is Authenticated) { Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => state.user.role == UserRole.user ? const UserMainWrapper() : const StoreMainWrapper()), (route) => false); }
