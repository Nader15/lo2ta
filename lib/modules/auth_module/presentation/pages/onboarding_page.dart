...
import 'package:lo2ta/modules/auth_module/presentation/pages/onboarding_details_page.dart';
          ...
          PageView.builder(
            ...
            itemBuilder: (context, index) => Padding(
              ...
              child: Column(
                ...
                children: [
                  Container(padding: const EdgeInsets.all(40), decoration: BoxDecoration(color: AppTheme.primaryColor.withValues(alpha: 0.1), shape: BoxShape.circle), child: Icon(_content[index].icon, size: 100, color: AppTheme.primaryColor)).animate(key: ValueKey(index)).scale(duration: 600.ms, curve: Curves.elasticOut),
